...
export default function AdminDashboard() {
    ...
    // Create client without arguments (uses env vars internally)
    ...
    useEffect(() => {
        const loadDashboardData = async () => {
            ...
            const mrr = subs?.reduce((acc: number, sub: any) => acc + (sub.price_at_period || 0), 0) || 0;
        ...
        loadDashboardData();
    }, []); // Empty dependency array is fine here as supabase client is stable enough for this use case
